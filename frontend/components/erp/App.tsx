...
// HVAC i18n initialization (Russian translations for admin pages)
import './components/hvac/config/i18n';

// HVAC Admin pages
import HvacNewsList from './components/hvac/pages/NewsList';
import HvacNewsEditor from './components/hvac/pages/NewsEditor';
import HvacDraftsPage from './components/hvac/pages/DraftsPage';
import HvacScheduledPage from './components/hvac/pages/ScheduledPage';
import HvacSearchSettingsPage from './components/hvac/pages/SearchSettingsPage';
import HvacDiscoveryAnalyticsPage from './components/hvac/pages/DiscoveryAnalyticsPage';
import HvacNewsNotFoundPage from './components/hvac/pages/NewsNotFound';
import HvacManufacturersPage from './components/hvac/pages/ManufacturersPage';
import HvacBrandsPage from './components/hvac/pages/BrandsPage';
import HvacResourcesPage from './components/hvac/pages/ResourcesPage';
...
export default function App() {
  ...
  const handleLogout = () => {
    api.logout();
    // Очищаем cookie для Next.js middleware
    document.cookie = 'access_token=; path=/; max-age=0';
    // Перенаправляем на главную (выходим из ERP SPA на публичный сайт)
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <Router basename="/erp">
        <Routes>
          ...
          <Route path="/hvac/news/create" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacNewsEditor />
              </Layout>
          ...
          <Route path="/hvac/news/edit/:id" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacNewsEditor />
              </Layout>
          ...
          <Route path="/hvac/drafts" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacDraftsPage />
              </Layout>
          ...
          <Route path="/hvac/scheduled" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacScheduledPage />
              </Layout>
          ...
          <Route path="/hvac/search-settings" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacSearchSettingsPage />
              </Layout>
            </ProtectedRoute>
          } />
          <Route path="/hvac/analytics" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacDiscoveryAnalyticsPage />
              </Layout>
            </ProtectedRoute>
          } />
          <Route path="/hvac/news/not-found" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacNewsNotFoundPage />
              </Layout>
            </ProtectedRoute>
          } />
          <Route path="/hvac/manufacturers" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacManufacturersPage />
              </Layout>
            </ProtectedRoute>
          } />
          <Route path="/hvac/brands" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacBrandsPage />
              </Layout>
          ...
          <Route path="/hvac/resources" element={
            <ProtectedRoute>
              <Layout onLogout={handleLogout} user={user}>
                <HvacResourcesPage />
              </Layout>
