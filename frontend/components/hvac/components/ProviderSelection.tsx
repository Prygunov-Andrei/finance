  ...
  useEffect(() => {
    const fetchProviders = async () => {
      ...
      try {
        ...
        setProviders([
          { id: 'openai', name: 'OpenAI GPT', description: '', available: false },
          { id: 'anthropic', name: 'Anthropic Claude', description: '', available: false },
          { id: 'google', name: 'Google Gemini', description: '', available: false },
        ]);
