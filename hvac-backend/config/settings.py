...
# Load environment variables from .env (for local dev; in Docker env vars come from compose)
...
STATIC_URL = '/hvac-static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'

MEDIA_URL = '/hvac-media/'
...
# ERP Service Token (для доступа из единого портала)
ERP_SERVICE_TOKEN = os.environ.get('ERP_SERVICE_TOKEN', '')
