...
# TD-01 (2026-04-23): попытка поднять до 142 — фактический recall на
# живом прогоне после TD-01 = 140 (не 149-152 как было в ТЗ). Порог
# оставляем 140 — это живая нижняя граница. Поднимать дальше только
# после нескольких прогонов со стабильными ≥142.
LLM_MIN_ITEMS = 140
LLM_MIN_SECTIONS = 6
