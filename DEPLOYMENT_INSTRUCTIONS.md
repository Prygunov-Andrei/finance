# 🚀 Инструкция по развертыванию на сервере 217.151.231.96
...
Скрипт автоматически установит webhook на `http://217.151.231.96/bot/webhook`.
...
5. Введите URL: `http://217.151.231.96/miniapp/`
6. Сохраните
...
- Создайте A-запись: `your-domain.com` → `217.151.231.96`
...
### 1. ERP Frontend
Откройте в браузере: `http://217.151.231.96/`
